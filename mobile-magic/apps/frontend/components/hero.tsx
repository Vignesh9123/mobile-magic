	...
	return (
	   ...
	   >
              ...
              <motion.div variants={itemVariants} className="group flex items-center justify-center">
                <p
                  className="mt-4 w-fit rounded-full text-center border border-teal-300/30 dark:border-teal-200/10 font-semibold bg-teal-100 dark:bg-teal-200/5 tracking-wide text-teal-400/90 dark:text-teal-300/70 px-4 py-1 transition-all duration-300 ease-in-out"
                >
